...
@interface LZDNextViewController () <UINavigationControllerDelegate>
...
@implementation LZDNextViewController
...
// 进入新界面
- (void)toNextView {
    LZDViewController *nextVC = [[LZDViewController alloc] init];
