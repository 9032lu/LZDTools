 ...
 *  代理
 */
@protocol LZDLoopDelegate <NSObject>
 ...
 *  @param index     图片索引
 */
- (void)loopView:(LZDLoopView *)loopView clickImageAtIndex:(NSInteger)index;
...
@property (nonatomic, assign) viewType cardViewType;
//当前显示图片的索引
 ...
 *  代理，用来处理图片的点击
 */
@property (nonatomic, weak) id<LZDLoopDelegate> lzdLoopDelegate;
